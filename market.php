...
//			if ($products_price = xtc_get_products_special_price($prev_prod['products_id'])) {
			...
			echo "<offer id=\"" . $prev_prod['products_id'] . "\" available=\"" . $available . "\">\n" .
					 "  <url>" . xtc_href_link(FILENAME_PRODUCT_INFO, xtc_product_link($prev_prod['products_id'], $prev_prod['products_name']) . '&amp;language=' . $prev_prod['language'] . $yml_referer, 'NONSSL', false) . "</url>\n" .
