...
/* -----------------------------------------------------------------------------------------
  ...
  $box_content='';
  $box_content=vam_draw_form('currencies', vam_href_link(basename($_SERVER['PHP_SELF']), '', $request_type, false), 'get').vam_draw_pull_down_menu('currency', $currencies_array, $_SESSION['currency'], 'onchange="this.form.submit();"') . $hidden_get_variables . vam_hide_session_id().'</form>';
