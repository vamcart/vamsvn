...
if (!vam_session_is_registered('customer_id')) {
	...
	$box->assign('FIELD_EMAIL', vam_draw_input_field('email_address', '', 'size="15" maxlength="30"'));
	$box->assign('FIELD_PWD', vam_draw_password_field('password', '', 'size="15" maxlength="30"'));
