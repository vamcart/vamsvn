...
$bender->enqueue("templates/".CURRENT_TEMPLATE."/css/vamshop3.css");
$bender->enqueue("templates/".CURRENT_TEMPLATE."/css/menu.css");
$bender->enqueue("templates/".CURRENT_TEMPLATE."/css/menu-overlay-effect.css");
$bender->enqueue("templates/".CURRENT_TEMPLATE."/css/menu-push-effect.css");
$bender->enqueue("templates/".CURRENT_TEMPLATE."/css/menu-shrink-effect.css");
$bender->enqueue("templates/".CURRENT_TEMPLATE."/css/menu-rightsidebar.css");
$bender->enqueue("templates/".CURRENT_TEMPLATE."/css/menu-horizontal-navigation.css");
$bender->enqueue("templates/".CURRENT_TEMPLATE."/css/menu-theme-color.css");
$bender->enqueue("templates/".CURRENT_TEMPLATE."/css/extra.css");
$bender->enqueue("templates/".CURRENT_TEMPLATE."/css/header.css");
?>
<?php
