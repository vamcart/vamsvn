...
$box->assign('FORM_ACTION', vam_draw_form('search', vam_href_link(FILENAME_ADVANCED_SEARCH_RESULT, '', 'NONSSL', false), 'get', 'class="form-inline" autocomplete="off"').vam_hide_session_id());
