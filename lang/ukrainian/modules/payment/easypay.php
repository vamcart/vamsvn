...
/* -----------------------------------------------------------------------------------------
  ...
  define('MODULE_PAYMENT_EASYPAY_TEXT_ADMIN_DESCRIPTION', 'Модуль оплаты EasyPay<br />Как правильно настроить модуль читайте <a href="http://vamshop.ru/blog/2012/10/23/vamshop-%d0%bf%d0%be%d0%b4%d0%ba%d0%bb%d1%8e%d1%87%d1%91%d0%bd-%d0%ba-easypay/" target="_blank"><u>здесь</u></a>.');
  define('MODULE_PAYMENT_EASYPAY_TEXT_DESCRIPTION', 'После нажатия кнопки Подтвердить заказ Вы перейдёте на сайт платёжной системы для оплаты заказа, после оплаты Ваш заказ будет выполнен.');
	...
	define('MODULE_PAYMENT_EASYPAY_STATUS_TITLE' , 'Разрешить модуль EasyPay');
