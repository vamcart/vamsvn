...
define('HEADING_TITLE', 'Скидки по брэндам');

define('TABLE_HEADING_CATEGORY', 'Брэнд');
define('TABLE_HEADING_SPECIAL_PRODUCT', 'Товар(ы)');
define('TABLE_HEADING_CATEGORY_DISCOUNT', 'Скидка брэнда');
define('TABLE_HEADING_STATUS', 'Статус');
define('TABLE_HEADING_ACTION', 'Действие');

define('TEXT_SPECIALS_CATEGORY', 'Брэнд:');
...
define('TEXT_SPECIALS_OVERRIDE', 'Переписать скидку если у товара данного брэнда уже была установлена скидка ранее.');
...
define('TEXT_INFO_HEADING_DELETE_SPECIALS', 'Удалить скидки из брэнда');
define('TEXT_INFO_DELETE_INTRO', 'Вы действительно хотите удалить скидки из данного брэнда?');
