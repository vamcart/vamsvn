...
define('TEXT_INFO_SET_AS_DEFAULT', TEXT_SET_DEFAULT . ' (у валюты по умолчанию в опции значение должно быть указано 1, курсы (значения) остальных валют должны быть пересчитаны относительно валюты по умолчанию)');
