...
define('BOX_CATEGORIES_TITLE', 'Разделы');
define('BOX_CONTENT_TITLE', 'Узнайте больше');
define('BOX_INFORMATION_TITLE', 'Информация');
define('BOX_ADD_QUICKIE_TITLE', 'Быстрый заказ');
define('BOX_LAST_VIEWED_TITLE', 'Просмотренные товары');
define('BOX_REVIEWS_TITLE', 'Отзывы');
define('BOX_SEARCH_TITLE', 'Поиск');
define('BOX_SPECIALS_TITLE', 'Скидки');
define('BOX_FEATURED_TITLE', 'Рекомендуемые');
define('BOX_LATESTNEWS_TITLE', 'Новости');
define('BOX_ARTICLES_TITLE', 'Статьи');
define('BOX_ARTICLESNEW_TITLE', 'Новые статьи');
define('BOX_AUTHORS_TITLE', 'Авторы');
define('BOX_CART_TITLE', 'Корзина');
define('BOX_LOGIN_TITLE', 'Вход');
define('BOX_ADMIN_TITLE', 'Информация');
define('BOX_DOWNLOADS_TITLE', 'Мои загрузки');
define('BOX_AFFILIATE_TITLE', 'Партнёрская программа');
define('BOX_WHATSNEW_TITLE', 'Новинки');
define('BOX_NEWSLETTER_TITLE', 'Рассылка');
define('BOX_BESTSELLERS_TITLE', 'Лучшие товары');
define('BOX_INFOBOX_TITLE', 'Информация о группе');
define('BOX_CURRENCIES_TITLE', 'Валюты');
define('BOX_LANGUAGES_TITLE', 'Языки');
define('BOX_MANUFACTURERS_TITLE', 'Производитель');
define('BOX_MANUFACTURERS_INFO_TITLE', 'Информация о производителе');
define('BOX_FAQ_TITLE', 'Вопросы и ответы');

define('BOX_CATEGORIES_DESC', 'Включить/выключить бокс.');
define('BOX_CONTENT_DESC', 'Включить/выключить бокс.');
define('BOX_INFORMATION_DESC', 'Включить/выключить бокс.');
define('BOX_ADD_QUICKIE_DESC', 'Включить/выключить бокс.');
define('BOX_LAST_VIEWED_DESC', 'Включить/выключить бокс.');
define('BOX_REVIEWS_DESC', 'Включить/выключить бокс.');
define('BOX_SEARCH_DESC', 'Включить/выключить бокс.');
define('BOX_SPECIALS_DESC', 'Включить/выключить бокс.');
define('BOX_FEATURED_DESC', 'Включить/выключить бокс.');
define('BOX_LATESTNEWS_DESC', 'Включить/выключить бокс.');
define('BOX_ARTICLES_DESC', 'Включить/выключить бокс.');
define('BOX_ARTICLESNEW_DESC', 'Включить/выключить бокс.');
define('BOX_AUTHORS_DESC', 'Включить/выключить бокс.');
define('BOX_CART_DESC', 'Включить/выключить бокс.');
define('BOX_LOGIN_DESC', 'Включить/выключить бокс.');
define('BOX_ADMIN_DESC', 'Включить/выключить бокс.');
define('BOX_DOWNLOADS_DESC', 'Включить/выключить бокс.');
define('BOX_AFFILIATE_DESC', 'Включить/выключить бокс.');
define('BOX_WHATSNEW_DESC', 'Включить/выключить бокс.');
define('BOX_NEWSLETTER_DESC', 'Включить/выключить бокс.');
define('BOX_BESTSELLERS_DESC', 'Включить/выключить бокс.');
define('BOX_INFOBOX_DESC', 'Включить/выключить бокс.');
define('BOX_CURRENCIES_DESC', 'Включить/выключить бокс.');
define('BOX_LANGUAGES_DESC', 'Включить/выключить бокс.');
define('BOX_MANUFACTURERS_DESC', 'Включить/выключить бокс.');
define('BOX_MANUFACTURERS_INFO_DESC', 'Включить/выключить бокс.');
define('BOX_FAQ_DESC', 'Включить/выключить бокс.');
