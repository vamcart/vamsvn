<?php
/* --------------------------------------------------------------
   $Id: buttons.php 1125 2006-04-29 02:40:57Z VaM $
...
define('BUTTON_STATUS_ON', 'Активна');
define('BUTTON_STATUS_OFF', 'Неактивна');
define('BUTTON_EDIT_ATTRIBUTES', 'Редактировать атрибуты');
