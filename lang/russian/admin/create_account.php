...
define('EMAIL_WARNING', '<b>Внимание:</b> Это e-mail адрес был дан нам одним из наших клиентов. Если Вы не подписывались и не регистрировались и не являетесь клиентом нашего магазина, отправьте, пожалуйста, e-mail администрации нашего магазина, чтобы Ваш адрес был удален ' . STORE_OWNER_EMAIL_ADDRESS . '.' . "\n");
