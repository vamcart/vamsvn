...
define('PRIVACY_TEXT_REGISTER','Нажимая кнопку Продолжить, я даю согласие на обработку своих персональных данных. <a href="shop_content.php?coID=3">Подробнее о защите персональной информации.</a>');
