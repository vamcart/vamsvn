...
define('MODULE_SHIPPING_SDEKPVZ_ZIP_TITLE' , 'Город отправителя');
define('MODULE_SHIPPING_SDEKPVZ_ZIP_DESC' , 'Укажите название города отправителя.');
...
define('MODULE_SHIPPING_SDEKPVZ_MIN_SUM_TITLE' , 'Мин. сумма от которой действует скидка');
define('MODULE_SHIPPING_SDEKPVZ_PROCENT_TITLE' , 'Процент скидки');
define('MODULE_SHIPPING_SDEKPVZ_MIN_SUM_ORDER_TITLE' , 'Минимальная сумма от которой действует доставка');
?>