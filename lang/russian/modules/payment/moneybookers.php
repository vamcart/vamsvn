<?php
/* -----------------------------------------------------------------------------------------
   $Id: moneybookers.php 998 2005-07-07 14:18:20Z VaM $
...
define('MODULE_PAYMENT_MONEYBOOKERS_TEXT_INFO','');
  ...
  define('MODULE_PAYMENT_MONEYBOOKERS_SORT_ORDER_TITLE','Порядок сортировки');
  define('MODULE_PAYMENT_MONEYBOOKERS_SORT_ORDER_DESC','Порядок сортировки модуля.');
  ...
  define('MODULE_PAYMENT_MONEYBOOKERS_ZONE_TITLE','Зона');
  define('MODULE_PAYMENT_MONEYBOOKERS_ZONE_DESC','Если выбрана зона, то данный модуль оплаты будет виден только покупателям из выбранной зоны.');
  define('MODULE_PAYMENT_MONEYBOOKERS_ORDER_STATUS_ID_TITLE','Статус заказа');
  define('MODULE_PAYMENT_MONEYBOOKERS_ORDER_STATUS_ID_DESC','Заказы, оформленные с использованием данного модуля оплаты будут принимать указанный статус.');
  ?>