...
------------------------------------------------------------------------------*/
  ...
  define('TEXT_CVV', '<table align="center" cellspacing="2" cellpadding="5" width="400"><tr><td><span class="tableHeading"><b>Карточки Visa, Mastercard, Discover имеют трёхзначный код верификации</b></span></td></tr><tr><td><span class="boxText">Для Вашей безопасноти, мы требуем в обязательном порядке указывать данный код. Код верификации - это трёхзначный номер, напечатанный на обратной стороне Вашей карточки. Он находится правее номера кредитной карточки.</span></td></tr><tr><td align="center"><IMG src="images/cv_card.gif"></td></tr></table><hr /><table align="center" cellspacing="2" cellpadding="5" width="400"><tr><td><span class="main"><b>Карточки American Express имеют 4 значный код</b> </span></td></tr><tr><td><span class="boxText">Для Вашей безопасноти, мы требуем в обязательном порядке указывать данный код. Код верификации - это четырёхзначный номер, напечатанный на карточке. Он находится выше и правее номера кредитной карточки.</span></td></tr><tr><td align="center"><IMG src="images/cv_amex_card.gif"></td></tr></table>');
  ...
  define('MODULE_PAYMENT_CC_EMAIL_DESC', 'Если указан eMail, средние цифры номера кредитной карточки будут отправлены на указанный eMail (остальные цифры номера хранятся в базе данных, те цифры, что отправлены на eMail, будут вырезаны из номера кредитной карточки.');
