...
************************************************************************
  Copyright (C) 2001 - 2003 TheMedia, Dipl.-Ing Thomas Plдnkers
...
*************************************************************************
  ...
  define('MODULE_PAYMENT_ICLEAR_TEXT_TITLE', 'iclear Rechnungskauf (Nur fьr iclear Mitglieder)');
  define('MODULE_PAYMENT_ICLEAR_TEXT_DESCRIPTION', 'iclear');
  define('MODULE_PAYMENT_ICLEAR_TEXT_ERROR_MESSAGE', 'Bei der &Uuml;berp&uuml;fung Ihres iclear Rechnungskaufes ist ein Fehler aufgetreten! Bitte versuchen Sie es nochmal oder wдhlen Sie eine andere Zahlungsweise.');
