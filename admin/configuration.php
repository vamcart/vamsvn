...
<?php
  ...
  while ($configuration = vam_db_fetch_array($configuration_query)) {
   ...
   echo '
  <tr>
    <td width="300" align="left" valign="top" class="dataTableContent-'.$class.'">'.constant(strtoupper($configuration['configuration_key'].'_TITLE')).' <span class="text-muted" data-toggle="tooltip" data-placement="top" title="'.constant(strtoupper( $configuration['configuration_key'].'_DESC')).'"><i class="far fa-question-circle"></i></span></td>
