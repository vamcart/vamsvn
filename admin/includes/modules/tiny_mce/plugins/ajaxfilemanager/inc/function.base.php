...
function addNoCacheHeaders() {
	...
	{
		$roorPath = realpath(strtolower(backslashToSlash(addTrailingSlash(CONFIG_SYS_ROOT_PATH))));
		
		if(file_exists($value) && strpos(realpath(strtolower(backslashToSlash(addTrailingSlash($value)))), $roorPath) === 0 )
		{
			return true;
		}
		return false;
