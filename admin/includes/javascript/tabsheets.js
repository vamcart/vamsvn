...
o = (window.addEventListener || window.attachEvent ? window : document.addEventListener ? document : null);
if (o.addEventListener) o.addEventListener('load', Make_Tabsheet, false);
else if (o.attachEvent) o.attachEvent('onload', Make_Tabsheet);
