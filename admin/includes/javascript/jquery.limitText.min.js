...
;(function($) {
    $.textcounter = function(el, options) {
            ...
            if (base.options.max !== -1) {  // if a maximum value has been set
                if (textCount === base.options.max && base.options.max !== 0) {
                    ...
                    if (base.options.stopInputAtMaximum) {  // if the string should be trimmed at the maximum length
                        ...
                        if (base.options.type == "comma") {  // comma type
                        ...
                        if (base.options.type == "character") {  // character type
        ...
        base.textCount = function(text) {
            ...
            if (base.options.type == "character") {  // character count
                textCount = base.characterCount(text);
            }
            if (base.options.type == "comma") {  // comma count
                textCount = base.commaCount(text);
            }
    ...
    $.textcounter.defaultOptions = {
        ...
        'counterText'                 : "Всего: %d",               // counter text
        'errorTextElement'            : "div",                           // error text element
        'minimumErrorText'            : "Minimum not met",               // error message for minimum not met,
        'maximumErrorText'            : "Максимум превышен",              // error message for maximum range exceeded,
