...
/* --------------------------------------------------------------
  ...
  if (($_SESSION['customers_status']['customers_status_id'] == '0') && ($admin_access['featured'] == '1')) echo '<a href="' . xtc_href_link(FILENAME_FEATURED, '', 'NONSSL') . '" class="menuBoxContentLink"> -' . BOX_FEATURED . '</a><br>';
  ...
  if (($_SESSION['customers_status']['customers_status_id'] == '0') && ($admin_access['cip_manager'] == '1')) echo '<a href="' . xtc_href_link(FILENAME_CIP_MANAGER) . '" class="menuBoxContentLink"> -' . BOX_CONTRIBUTION_INSTALLER . '</a><br>';
  ...
  if (($_SESSION['customers_status']['customers_status_id'] == '0') && ($admin_access['authors'] == '1')) echo '<a href="' . xtc_href_link(FILENAME_AUTHORS, '', 'NONSSL') . '" class="menuBoxContentLink"> -' . BOX_ARTICLES_AUTHORS . '</a><br>';
  ...
  if (($_SESSION['customers_status']['customers_status_id'] == '0') && ($admin_access['csv_backend'] == '1')) echo '<a href="' . xtc_href_link(FILENAME_CSV_BACKEND, '', 'NONSSL') . '" class="menuBoxContentLink"> -' . BOX_IMPORT . '</a><br>';
  if (($_SESSION['customers_status']['customers_status_id'] == '0') && ($admin_access['easypopulate'] == '1')) echo '<a href="' . xtc_href_link(FILENAME_EASYPOPULATE, '', 'NONSSL') . '" class="menuBoxContentLink"> -' . BOX_EASY_POPULATE . '</a><br>';
  if (($_SESSION['customers_status']['customers_status_id'] == '0') && ($admin_access['quick_updates'] == '1')) echo '<a href="' . xtc_href_link(FILENAME_QUICK_UPDATES, '', 'NONSSL') . '" class="menuBoxContentLink"> -' . BOX_CATALOG_QUICK_UPDATES . '</a><br>';
...
if (ACTIVATE_GIFT_SYSTEM=='true') {
  ...
  if (($_SESSION['customers_status']['customers_status_id'] == '0') && ($admin_access['cache'] == '1')) echo '<a href="' . xtc_href_link(FILENAME_CACHE, '', 'NONSSL') . '" class="menuBoxContentLink"> -' . BOX_CACHE_FILES . '</a><br>';
...
//  if (($_SESSION['customers_status']['customers_status_id'] == '0') && ($admin_access['configuration'] == '1')) echo '<a href="' . xtc_href_link(FILENAME_CONFIGURATION, 'gID=19', 'NONSSL') . '" class="menuBoxContentLink"> -' . BOX_CONFIGURATION_19 . '</a><br>';
  ...
  if (($_SESSION['customers_status']['customers_status_id'] == '0') && ($admin_access['configuration'] == '1')) echo '<a href="' . xtc_href_link(FILENAME_CONFIGURATION, 'gID=23', 'NONSSL') . '" class="menuBoxContentLink"> -' . BOX_CONFIGURATION_23 . '</a><br>';
