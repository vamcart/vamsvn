...
<?php
  ...
  if (($_SESSION['customers_status']['customers_status_id'] == '0') && ($admin_access['faq1'] == '1')) echo '<li class=" "><a href="' . vam_href_link(FILENAME_FAQ1) . '"><span class="vamshop-menu-micon"><i class="fas fa-angle-right"></i></span><span class="vamshop-menu-mtext">' .  BOX_CATALOG_FAQ1  . '</span><span class="vamshop-menu-mcaret"></span></a></li>' . "\n";
  if (($_SESSION['customers_status']['customers_status_id'] == '0') && ($admin_access['block'] == '1')) echo '<li class=" "><a href="' . vam_href_link(FILENAME_BLOCK) . '"><span class="vamshop-menu-micon"><i class="fas fa-angle-right"></i></span><span class="vamshop-menu-mtext">' .  BOX_CATALOG_BLOCK  . '</span><span class="vamshop-menu-mcaret"></span></a></li>' . "\n";
...
<?php
  ...
  if (($_SESSION['customers_status']['customers_status_id'] == '0') && ($admin_access['stats_sales_report'] == '1')) echo '<li class=" "><a href="' . vam_href_link(FILENAME_SALES_REPORT, '', 'NONSSL') . '"><span class="vamshop-menu-micon"><i class="fas fa-angle-right"></i></span><span class="vamshop-menu-mtext">' . BOX_SALES_REPORT . '</span><span class="vamshop-menu-mcaret"></span></a></li>' . "\n";
  if (($_SESSION['customers_status']['customers_status_id'] == '0') && ($admin_access['stats_sales_report2'] == '1')) echo '<li class=" "><a href="' . vam_href_link(FILENAME_STATS_SALES_REPORT2, '', 'NONSSL') . '"><span class="vamshop-menu-micon"><i class="fas fa-angle-right"></i></span><span class="vamshop-menu-mtext">' . BOX_SALES_REPORT2 . '</span><span class="vamshop-menu-mcaret"></span></a></li>' . "\n";
  if (($_SESSION['customers_status']['customers_status_id'] == '0') && ($admin_access['stats_campaigns'] == '1')) echo '<li class=" "><a href="' . vam_href_link(FILENAME_CAMPAIGNS_REPORT, '', 'NONSSL') . '"><span class="vamshop-menu-micon"><i class="fas fa-angle-right"></i></span><span class="vamshop-menu-mtext">' . BOX_CAMPAIGNS_REPORT . '</span><span class="vamshop-menu-mcaret"></span></a></li>' . "\n";
