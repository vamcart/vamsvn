    ...
    switch ($_GET['action']) {
      ...
      case 'insert_review': //insert a new item.
        ...
        $avatar = $_POST['customers_avatar_name'];
          ...
          $sql_data_array = array('products_id'   => '0',
                                  'customers_id'    => '0',
                                  ...
                                  'reviews_read'     => '1' );
          vam_db_perform(TABLE_SITE_REVIEWS, $sql_data_array);
          ...
          vam_db_perform(TABLE_SITE_REVIEWS_DESCRIPTION, $sql_data_array);
...
<!-- body_text //-->
    ...
    <table border="0" width="100%" cellspacing="0" cellpadding="2">
      ...
      <tr><?php echo vam_draw_form('add_review', FILENAME_SITE_REVIEWS_ADD, vam_get_all_get_params(array('action')) . 'action=insert_review', 'post', 'enctype="multipart/form-data"'); ?>
