      ...
      <tr>
        <td><table witdh="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td class="main star-rating"><?php for ($i=1; $i<=5; $i++) echo vam_draw_radio_field('reviews_rating', $i, (($i == 4) ? true : false), '', 'class="star-rating" id="star'.$i.'"').'<label for="star'.$i.'" title="'.constant('RATING_STAR_'.$i).'">'.constant('TEXT_STAR_'.$i).'</label>'; ?>
          </tr>
        </table></td>
      </tr>
      <tr>
