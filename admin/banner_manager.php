...
<?php
    $banners_query_raw = "select banners_id, banners_title, banners_description, banners_image, banners_group, status, expires_date, expires_impressions, date_status_change, date_scheduled, date_added from " . TABLE_BANNERS . " order by banners_group, banners_title";
