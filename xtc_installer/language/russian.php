...
define('TEXT_WS_XTC_LONG','Путь до директории, где находится интернет-магазин, обычно <i>/</i> или <i>/home/myname/public_html/xtcommerce/</i><br /> В большинстве случаев, Вам не нужно прописывать путь до директории, скрипт установки автоматически определит местонахождение магазина и пропишет путь до директории автоматически.');
define('TEXT_WS_ADMIN','Директория админки интернет-магазина');
define('TEXT_WS_ADMIN_LONG','Путь до директории, где находится админка интернет-магазина, обычно <i>/admin/</i> или <i>/home/myname/public_html/xtcommerce/admin/</i><br /> В большинстве случаев, Вам не нужно прописывать путь до директории, скрипт установки автоматически определит местонахождение админки и пропишет путь до директории автоматически.');
