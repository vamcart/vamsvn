...
define('TEXT_WELCOME_STEP2','<b>Установка базы данных</b><br /><br />The XT-Commerce installer will automatically install the XT-Commerce database.');
define('TEXT_WELCOME_STEP3','<b>Импорт базы данных.</b><br /><br />');
define('TEXT_WELCOME_STEP4','<b>Настройка основных файлов XT-Commerce</b><br /><br /><b>Если есть старые конфигурационные файлы от предыдущих установок, XT-Commerce удалит их автоматически.</b><br /><br />Инсталлятор сконфигурирует основные параметры БД и структуру файлов.');
...
define('TITLE_CUSTOM_SETTINGS','Настройка базы данных');
define('TEXT_IMPORT_DB','Импорт базы данных');
define('TEXT_IMPORT_DB_LONG','Импорт структуры базы данных XT-Commerce и данных.');
...
define('TEXT_WS_XTC','Абсолютный путь интернет-магазина');
define('TEXT_WS_XTC_LONG','Полный путь до директории, где находится интернет-магазин, например <i>/home/myname/public_html/xtcommerce/</i><br /> В большинстве случаев, Вам не нужно прописывать путь до директории, скрипт установки автоматически определит местонахождение магазина и пропишет путь до директории автоматически.');
define('TEXT_WS_ADMIN','Абсолютный путь админки интернет-магазина');
define('TEXT_WS_ADMIN_LONG','Полный путь до директории, где находится админка интернет-магазина, например <i>/home/myname/public_html/xtcommerce/admin/</i><br /> В большинстве случаев, Вам не нужно прописывать путь до директории, скрипт установки автоматически определит местонахождение админки и пропишет путь до директории автоматически.');
define('TEXT_WS_CATALOG','Директория интернет-магазина');
define('TEXT_WS_CATALOG_LONG','Виртуальная директория с магазином, например <i>/xtcommerce/</i><br /> В большинстве случаев, Вам не нужно прописывать директорию, скрипт установки автоматически определит местонахождение магазина и пропишет путь до виртуальной директории автоматически.');
define('TEXT_WS_ADMINTOOL','Директория админки интернет-магазина');
define('TEXT_WS_ADMINTOOL_LONG','Виртуальная директория с админкой магазина, например <i>/xtcommerce/admin/</i><br /> В большинстве случаев, Вам не нужно прописывать директорию, скрипт установки автоматически определит местонахождение админки и пропишет путь до виртуальной директории автоматически.');
...
define('TITLE_WEBSERVER_CONFIGURATION','Настройки веб-сервера:');
...
define('TEXT_VALUES','Были записаны следующие значения:');
...
define('TEXT_SESS_LONG','Путь до деректории хранения файлов PHP сессий.');

// install_step5.php

define('TEXT_WS_CONFIGURATION_SUCCESS','<strong>XT-Commerce VaM Edition</strong> Настройка веб-сервера успешно завершена');
...
define('TEXT_COUNTRY_LONG','Будет использоваться при подсчёте стоимость доставки и налога');
...
define('TEXT_STATUS_DISCOUNT','Скидки на товар');
define('TEXT_STATUS_DISCOUNT_LONG','Скидки на товар <i>(в процентах, например 10.00, 20.00)</i>');
define('TEXT_STATUS_OT_DISCOUNT_FLAG','Скидка на странице подтверждения заказа');
define('TEXT_STATUS_OT_DISCOUNT_FLAG_LONG','Разрешить гостям получать скидку на странице подтверждения заказа');
...
define('TEXT_STATUS_GRADUATED_PRICE_LONG','Разрещить посетителям видеть цены в зависимости от количества заказанных единиц товара');
