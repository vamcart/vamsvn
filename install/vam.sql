...
(1, 1, 1, 'Экран', 'Отфильтрованные ноутбуки с выбранным размеров экрана.', '', '', '', 'display'),
(2, 2, 1, 'Батарея', 'Отфильтрованные ноутбуки с выбраной батареей.', '', '', '', 'battery'),
(3, 3, 1, 'Вес', 'Отфильтрованные ноутбуки с выбранным весом.', '', '', '', 'weight'),
(4, 4, 1, 'Память', 'Отфильтрованные ноутбуки с выбранным объёмом памяти.', '', '', '', 'memory'),
(5, 5, 1, 'Размеры', 'Отфильтрованные ноутбуки с выбранным размером.', '', '', '', 'dimensions'),
(6, 6, 1, 'Экран', 'Отфильтрованные планшеты с выбранным экраном.', '', '', '', 'display'),
(7, 7, 1, 'Батарея', 'Отфильтрованные планшеты с выбранной батареей.', '', '', '', 'battery'),
(8, 8, 1, 'Вес', 'Отфильтрованные планшеты с выбранным весом.', '', '', '', 'weight'),
(9, 9, 1, 'Память', 'Отфильтрованные планшеты с выбранным объёмом памяти.', '', '', '', 'memory'),
(10, 10, 1, 'Размеры', 'Отфильтрованные планшеты с выбранным размером.', '', '', '', 'dimensions'),
(11, 11, 1, 'Экран', 'Отфильтрованные смартфоны с выбранным экраном.', '', '', '', 'display'),
(12, 12, 1, 'Батарея', 'Отфильтрованные смартфоны с выбранной батареей.', '', '', '', 'battery'),
(13, 13, 1, 'Вес', 'Отфильтрованные смартфоны с выбранным весом.', '', '', '', 'weight'),
(14, 14, 1, 'Память', 'Отфильтрованные смартфоны с выбранным объёмом памяти.', '', '', '', 'memory'),
(15, 15, 1, 'Размеры', 'Отфильтрованные смартфоны с выбранным размером.', '', '', '', 'dimensions');
