...
(6, 'Скидки', 'Выбрать тип слайдера можно в Админке - Настройки - Основные - Мой магазин - Слайдер по умолчанию.', '', '', '', 'specials.php', '', 'slider_basic', 'Если не используется картинка, то данное поле надо обязательно заполнить, иначе баннер не сохранится.', NULL, NULL, NULL, '2019-04-07 23:21:15', NULL, 0),
(7, 'Рекомендуемые', 'Вам доступно на выбор 6 различных типов слайдеров, каруселей.', '', '', '', 'featured.php', '', 'slider_basic', 'Если не используется картинка, то данное поле надо обязательно заполнить, иначе баннер не сохранится.', NULL, NULL, NULL, '2019-04-07 23:32:44', NULL, 0),
(8, 'Новинки', 'Управлять данными баннерами можно в Админке - Контент - Управление баннерами.', '', '', '', 'products_new.php', '', 'slider_basic', 'Если не используется картинка, то данное поле надо обязательно заполнить, иначе баннер не сохранится.', NULL, NULL, NULL, '2019-04-07 23:37:00', NULL, 0),
