...
(8, 'Новинки', 'Управлять данными баннерами можно в Админке - Разное - Инструменты - Управление баннерами.', 'products_new.php', '', 'slider_basic', 'Если не используется картинка, то данное поле надо обязательно заполнить, иначе баннер не сохранится.', NULL, NULL, NULL, '2019-04-07 23:37:00', NULL, 1),
