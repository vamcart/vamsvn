...
if (!$product->isProduct()) {
	...
	vam_draw_radio_field('rating', '5', '', 'id="star5" class="star-rating"').'<label for="star5" title="'.TEXT_STAR_5.'"><span class="d-none d-lg-block">'.RATING_STAR_5.'</span></label>' .
	vam_draw_radio_field('rating', '4', '', 'id="star4" class="star-rating"').'<label for="star4" title="'.TEXT_STAR_4.'"><span class="d-none d-lg-block">'.RATING_STAR_4.'</span></label>'.
	vam_draw_radio_field('rating', '3', '', 'id="star3" class="star-rating"').'<label for="star3" title="'.TEXT_STAR_3.'"><span class="d-none d-lg-block">'.RATING_STAR_3.'</span></label>'.
	vam_draw_radio_field('rating', '2', '', 'id="star2" class="star-rating"').'<label for="star2" title="'.TEXT_STAR_2.'"><span class="d-none d-lg-block">'.RATING_STAR_2.'</span></label>'.
	vam_draw_radio_field('rating', '1', '', 'id="star1" class="star-rating"').'<label for="star1" title="'.TEXT_STAR_1.'"><span class="d-none d-lg-block">'.RATING_STAR_1.'</span></label>'
...
$vamTemplate->display("string:{$main_content}");
