...
// TABLES: products_to_categories
  function vam_get_product_path($products_id) {
    ...
    $category_query = "select p2c.categories_id from " . TABLE_PRODUCTS . " p, " . TABLE_PRODUCTS_TO_CATEGORIES . " p2c where p.products_id = '" . (int)$products_id . "' and p.products_status = '1' and p.products_id = p2c.products_id and p2c.categories_id != 0 order by p2c.categories_id desc limit 1";
