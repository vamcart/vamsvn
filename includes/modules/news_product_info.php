...
$sql_news = "
    SELECT
        ...
        n.content,
        n.date_added
    FROM " . TABLE_LATEST_NEWS . " n , " . TABLE_LATEST_NEWS_TO_PRODUCTS . " n2c
    WHERE
         n2c.products_id = '" . (int)$news_category_id . "'
...
if (sizeof($module_content_news) > 0) {
	...
	// set cache ID
	 if (!CacheCheck()) {
		$module->caching = 0;
      $module= $module->fetch(CURRENT_TEMPLATE.'/module/latest_news_product_info.html');
	} else {
        $module->caching = 1;
        $module->cache_lifetime=CACHE_LIFETIME;
        $module->cache_modified_check=CACHE_CHECK;
        $module = $module->fetch(CURRENT_TEMPLATE.'/module/latest_news_product_info.html',$cache_id);
	}
	$info->assign('MODULE_latest_news', $module);
}
?>