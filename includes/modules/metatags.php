...
?>
<title><?php echo TEXT_BUY_BUTTON . ' ' . str_replace('+',' ', mb_convert_case($_GET['keywords'], MB_CASE_TITLE, "UTF-8")) . (isset($_GET['page']) && $_GET['page'] > 0 ? ' - ' . TEXT_PAGE_IN_CAT . ' ' . $_GET['page'] : null); ?></title>	
<meta name="description" content="<?php echo TEXT_BUY_BUTTON . ' ' . str_replace('+',' ', mb_convert_case($_GET['keywords'], MB_CASE_TITLE, "UTF-8")) . (isset($_GET['page']) && $_GET['page'] > 0 ? ' - ' . TEXT_PAGE_IN_CAT . ' ' . $_GET['page'] : null); ?>" />
<meta name="keywords" content="<?php echo META_KEYWORDS; ?>" />
<?php
