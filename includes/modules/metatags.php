...
<?php if (strstr($PHP_SELF, FILENAME_PRODUCTS_FILTERS)) { ?><link rel="canonical" href="<?php echo vam_href_link (FILENAME_PRODUCTS_FILTERS, vam_get_all_get_params (array ('f' . $specs_array['specifications_id']) ) ); ?>"/><?php } ?>
