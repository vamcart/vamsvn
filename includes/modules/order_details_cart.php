...
for ($i = 0, $n = sizeof($products); $i < $n; $i ++) {
	...
	'BOX_DELETE' => '<button class="button btn btn-default btn-secondary cart_delete" type="button" value="'.$products[$i]['id'].'"><span>X</span></button>', 
   'PLUS' => '<button class="button btn btn-default btn-secondary cart_change cart_plus" type="button" value="1"><span>+</span></button>',
   'MINUS' => '<button class="button btn btn-default btn-secondary cart_change cart_minus" type="button" value="-1"><span>-</span></button>',
