      ...
      $selection = array('id' => $this->code,
                         ...
                         'description'=>$this->info,
      	                 'fields' => array(array('title' => '<div id="schet">'.MODULE_PAYMENT_SCHET_J_NAME_TITLE,
      	                                   ...
      	                                   array('title' => MODULE_PAYMENT_SCHET_J_NAME.'<br />',
      	                                         'field' => vam_draw_input_field('s_name', $payment_data['name']) . '<br />' . MODULE_PAYMENT_SCHET_J_NAME_IP),
      	                                   array('title' => MODULE_PAYMENT_SCHET_J_INN.'<br />',
...
//      	                                         'field' => vam_draw_input_field('s_fakt_address')),
      	                                   array('title' => MODULE_PAYMENT_SCHET_J_TELEPHONE.'<br />',
