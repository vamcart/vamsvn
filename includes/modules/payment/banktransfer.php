<?php
/* -----------------------------------------------------------------------------------------
   $Id: banktransfer.php 1122 2007-02-06 21:07:20 VaM $   
   ...
   (c) 2004	 xt:Commerce (banktransfer.php,v 1.9 2003/08/23); xt-commerce.com
...
$this->info=MODULE_PAYMENT_BANKTRANSFER_TEXT_INFO;
    ...
    function after_process() {
      ...
      if ($_POST['banktransfer_fax'])
        vam_db_query("update banktransfer set banktransfer_fax = '" . $_POST['banktransfer_fax'] ."' where orders_id = '" . $insert_id . "'");
