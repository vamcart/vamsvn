...
//PIN				
    ...
    function process_button() {
      ...
      $process_button_string = '';
		...
		if (defined('MODULE_PAYMENT_YANDEX_MERCHANT_GP_SEND_CHECK') && constant('MODULE_PAYMENT_YANDEX_MERCHANT_GP_SEND_CHECK') == 'True') {
      ...
      $process_button_string = vam_draw_hidden_field('shopId', MODULE_PAYMENT_YANDEX_MERCHANT_GP_SHOP_ID) .
                               ...
                               (defined('MODULE_PAYMENT_YANDEX_MERCHANT_GP_SEND_CHECK') && constant('MODULE_PAYMENT_YANDEX_MERCHANT_GP_SEND_CHECK') == 'True' ? vam_draw_hidden_field('receipt', json_encode($receipt)) : '');
...
// unregister session variables used during checkout
    ...
    function install() {
      ...
      vam_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_key, configuration_value, configuration_group_id, sort_order, date_added) values ('MODULE_PAYMENT_YANDEX_MERCHANT_GP_SORT_ORDER', '0', '6', '6', now())");
      ...
      vam_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_key, configuration_value, configuration_group_id, sort_order, set_function, date_added) values ('MODULE_PAYMENT_YANDEX_MERCHANT_GP_SEND_CHECK', 'False', '6', '11', 'vam_cfg_select_option(array(\'True\', \'False\'), ', now())");
    }
