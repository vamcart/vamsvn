...
//PIN				
    ...
    function process_button() {
      ...
      $process_button_string = vam_draw_hidden_field('shopId', MODULE_PAYMENT_YANDEX_MERCHANT_SHOP_ID) .
                               ...
                               (defined('MODULE_PAYMENT_YANDEX_MERCHANT_SEND_CHECK') && constant('MODULE_PAYMENT_YANDEX_MERCHANT_SEND_CHECK') == 'True' ? vam_draw_hidden_field('ym_merchant_receipt', json_encode($receipt)) : '');
...
// unregister session variables used during checkout
    ...
    function install() {
      ...
      vam_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_key, configuration_value, configuration_group_id, sort_order, set_function, date_added) values ('MODULE_PAYMENT_YANDEX_MERCHANT_PAYMENT_TYPE', '', '6', '10', 'vam_cfg_select_option(array(\'\', \'PC\', \'AC\', \'MC\', \'GP\', \'WM\', \'SB\', \'MP\', \'AB\'), ', now())");
