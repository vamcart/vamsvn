             ...
             while($extra_fields = vam_db_fetch_array($extra_fields_query)){
                  ...
                  $extra_fields_string_name = $extra_fields['fields_name'];
                    ...
                    $select_values[] = array('id' => $item, 'text' => $item);
									...
									{
									  case  0: $extra_fields_string_value = vam_draw_input_field('fields_' . $extra_fields['fields_id'],$value, 'id="fields_'.$extra_fields['fields_id'].'"'). (($extra_fields['fields_required_status']==1) ? '&nbsp;<span class="Requirement">*</span>': ''); break;
