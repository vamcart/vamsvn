...
$orders_query = "select
  ...
  foreach ($products AS $product_id_in_cart) {
	...
	function getWishlistButton($id, $name) {
		...
		$link = '<a class="btn btn-add-to-cart btn-block" href="'.vam_href_link(FILENAME_SHOPPING_CART, 'action=wishlist_now&BUYproducts_id='.$id, 'NONSSL').'"><i class="far fa-heart"></i> '.IMAGE_BUTTON_IN_WISHLIST.'</a>';
		}
