...
class Sypex_Dumper {
	function Sypex_Dumper() {
		...
		$this->name = 'Sypex Dumper 2.0.7 RC';
	}
...
<link rel="stylesheet" type="text/css" href="load.php?sxd.v207.css">
<script type="text/javascript" src="load.php?sxd.v207.js"></script>
<script type="text/javascript" src="load.php?{$SXD->LNG['name']}.lng.js"></script>
<link rel="shortcut icon" href="load.php?favicon.v207.ico">
</head>
