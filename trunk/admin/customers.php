...
<?php include(DIR_WS_MODULES . FILENAME_CUSTOMER_MEMO); ?>
      ...
      <tr>
        <td align="right" class="main"><span class="button"><input type="submit" value="<?php echo BUTTON_UPDATE; ?>"></span><?php echo ' <a class="button" href="' . vam_href_link(FILENAME_CUSTOMERS, vam_get_all_get_params(array('action'))) .'"><span>' . BUTTON_CANCEL . '</span></a>'; ?></td>
      </tr></form>
<?php
...
<?php
	...
	switch ($_GET['action']) {
		case 'confirm' :
			...
			$contents[] = array ('align' => 'center', 'text' => '<br /><span class="button"><input type="submit" value="'.BUTTON_DELETE.'"></span><a class="button" href="'.vam_href_link(FILENAME_CUSTOMERS, vam_get_all_get_params(array ('cID', 'action')).'cID='.$cInfo->customers_id).'"><span>'.BUTTON_CANCEL.'</span></a>');
			break;
		...
		case 'editstatus' :
			if ($_GET['cID'] != 1) {
				...
				$contents[] = array ('align' => 'center', 'text' => '<br /><span class="button"><input type="submit" value="'.BUTTON_UPDATE.'"></span><a class="button" href="'.vam_href_link(FILENAME_CUSTOMERS, vam_get_all_get_params(array ('cID', 'action')).'cID='.$cInfo->customers_id).'"><span>'.BUTTON_CANCEL.'</span></a>');
