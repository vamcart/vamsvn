          ...
          <tr>
            <td><table width="100%" border="0" cellpadding="4" cellspacing="2" class="dataTableContent">
              <center>
                ...
                <tr>
                  <td align="right" class="dataTableContent" colspan="4"><?php echo '<a class="button" href="' . vam_href_link(FILENAME_AFFILIATE_CLICKS, 'acID=' . $_GET['acID']) . '">' . IMAGE_CLICKTHROUGHS . '</a> <a class="button" href="' . vam_href_link(FILENAME_AFFILIATE_SALES, 'acID=' . $_GET['acID']) . '">' . IMAGE_SALES . '</a>'; ?></td>
                </tr>
              </center>
            </table></td>
          </tr>
