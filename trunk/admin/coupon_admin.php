...
<?php
    ...
    echo xtc_draw_hidden_field('coupon_startdate', date('Y-m-d', mktime(0, 0, 0, $_POST['startdate-mm'],$_POST['startdate-dd'] ,$_POST['startdate'] )));
    echo xtc_draw_hidden_field('coupon_finishdate', date('Y-m-d', mktime(0, 0, 0, $_POST['finishdate-mm'],$_POST['finishdate-dd'] ,$_POST['finishdate'] )));
?>
     <tr>
...
?>
      ...
      <tr>
       ...
       <tr>
        ...
        <td align="left"><?php echo xtc_draw_input_field('coupon_products', $coupon_products); ?> <A HREF="validproducts.php" TARGET="_blank" ONCLICK="window.open('validproducts.php', 'Valid_Products', 'scrollbars=yes,resizable=yes,menubar=yes,width=600,height=600'); return false">View</A></td>
        <td align="left" class="main"><?php echo COUPON_PRODUCTS_HELP; ?></td>
      </tr>
      <tr>
        <td align="left" class="main"><?php echo COUPON_CATEGORIES; ?></td>
        <td align="left"><?php echo xtc_draw_input_field('coupon_categories', $coupon_categories); ?> <A HREF="validcategories.php" TARGET="_blank" ONCLICK="window.open('validcategories.php', 'Valid_Categories', 'scrollbars=yes,resizable=yes,menubar=yes,width=600,height=600'); return false">View</A></td>
...
?>
        ...
        <td align="left"><?php echo xtc_draw_input_field('startdate-dd', $coupon_startdate[2], "size=\"2\" id=\"startdate-dd\""); ?> / <?php echo xtc_draw_input_field('startdate-mm', $coupon_startdate[1], "size=\"2\" id=\"startdate-mm\""); ?> / <?php echo xtc_draw_input_field('startdate', $coupon_startdate[0], "size=\"4\" id=\"startdate\" class=\"format-d-m-y split-date\""); ?></td>
        <td align="left" class="main"><?php echo COUPON_STARTDATE_HELP; ?></td>
      </tr>
      <tr>
        <td align="left" class="main"><?php echo COUPON_FINISHDATE; ?></td>
        <td align="left"><?php echo xtc_draw_input_field('finishdate-dd', $coupon_finishdate[2], "size=\"2\" id=\"finishdate-dd\""); ?> / <?php echo xtc_draw_input_field('finishdate-mm', $coupon_finishdate[1], "size=\"2\" id=\"finishdate-mm\""); ?> / <?php echo xtc_draw_input_field('finishdate', $coupon_finishdate[0], "size=\"4\" id=\"finishdate\" class=\"format-d-m-y split-date\""); ?></td></td>
    ...
    <td  class="boxCenter" width="100%" valign="top"><table border="0" width="100%" cellspacing="0" cellpadding="2">
      <tr>
        <td width="100%"><table border="0" width="100%" cellspacing="0" cellpadding="0">
          <tr>
            <td colspan="2" class="main"><?php echo xtc_draw_form('status', FILENAME_COUPON_ADMIN, '', 'get'); ?>
<?php
...
<?php
    ...
    if ($status != '*') {
      $cc_query_raw = "select coupon_id, coupon_code, coupon_amount, coupon_type, coupon_start_date,coupon_expire_date,uses_per_user,uses_per_coupon,restrict_to_products, restrict_to_categories, date_created,date_modified from " . TABLE_COUPONS ." where coupon_active='" . xtc_db_input($status) . "' and coupon_type != 'G'";
    } else {
    ...
    default:
      ...
      if ($_GET['action'] == 'voucherdelete') {
        ...
        $contents[] = array('text'=>COUPON_NAME . '&nbsp;::&nbsp; ' . $coupon_name['coupon_name'] . '<br />' .
                     ...
                     '<table border=0 align=center><tr><td align="center"><a class="button" onClick="this.blur();" href="'.xtc_href_link('coupon_admin.php','action=email&cid='.$cInfo->coupon_id,'NONSSL').'">'.BUTTON_EMAIL.'</a></td></tr><tr><td align="center">' .
                     '<a class="button" onClick="this.blur();" href="'.xtc_href_link('coupon_admin.php','action=voucheredit&cid='.$cInfo->coupon_id,'NONSSL').'">'.BUTTON_EDIT.'</a></td></tr><tr><td align="center">' .
                     '<a class="button" onClick="this.blur();" href="'.xtc_href_link('coupon_admin.php','action=voucherdelete&cid='.$cInfo->coupon_id,'NONSSL').'">'.BUTTON_DELETE.'</a></td></tr><tr><td align="center">' .
                     '<a class="button" onClick="this.blur();" href="'.xtc_href_link('coupon_admin.php','action=voucherreport&cid='.$cInfo->coupon_id,'NONSSL').'">'.BUTTON_REPORT.'</a></center></td></tr>'
                     );
        }
        break;
      }
