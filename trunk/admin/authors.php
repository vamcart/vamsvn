...
-->
      <tr>
        <td class="main">&nbsp;</td>
        <td class="main" align="left"><?php echo vam_draw_separator('pixel_trans.gif', '24', '15') . '&nbsp;' . '<input type="submit" class="button" onClick="this.blur();" value="' . BUTTON_SAVE . '"/>' . ' <a class="button" href="' . vam_href_link(FILENAME_AUTHORS, 'page=' . $_GET['page'] . '&auID=' . $_GET['auID']) . '">' . BUTTON_CANCEL . '</a>'; ?></td>
      </form>
      </tr>
          </tr>
        </table></td>
...
-->
      <tr>
        <td class="main">&nbsp;</td>
        <td class="main" align="left"><?php echo vam_draw_separator('pixel_trans.gif', '24', '15') . '&nbsp;' . '<input type="submit" class="button" onClick="this.blur();" value="' . BUTTON_SAVE . '"/>' . ' <a class="button" href="' . vam_href_link(FILENAME_AUTHORS, 'page=' . $_GET['page'] . '&auID=' . $authors['authors_id']) . '">' . BUTTON_CANCEL . '</a>'; ?></td>
      </form>
      </tr>
          </tr>
        </table></td>
...
?>
              <tr>
                <td align="right" colspan="2" class="smallText"><?php echo '<a class="button" href="' . vam_href_link(FILENAME_AUTHORS, 'page=' . $_GET['page'] . '&auID=' . $auInfo->authors_id . '&action=new') . '">' . BUTTON_INSERT . '</a>'; ?></td>
              </tr>
<?php
  }
?>
...
<?php
  ...
  switch ($action) {
    case 'delete':
      ...
      $contents[] = array('align' => 'center', 'text' => '<br>' . '<input type="submit" class="button" onClick="this.blur();" value="' . BUTTON_DELETE . '"/>' . ' <a class="button" href="' . vam_href_link(FILENAME_AUTHORS, 'page=' . $_GET['page'] . '&auID=' . $auInfo->authors_id) . '">' . BUTTON_CANCEL . '</a>');
      break;
    default:
