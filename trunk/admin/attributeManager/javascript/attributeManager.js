...
function checkBox(id) {
    ...
    if(check[id]) //if a value is not true, use this rather than == false, 'cos the first time no value will be set and it will be undefined, not true or false
        {
        ...
        check[id] = !check[id]; //change the value for this checkbox in the array
        }
    else
        {
