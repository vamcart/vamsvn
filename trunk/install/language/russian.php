<?php
/* --------------------------------------------------------------
   $Id: russian.php 1213 2011-02-26 13:12:57 VaM $  
   ...
   (c) 2004	 xt:Commerce (russian.php,v 1.8 2003/08/13); xt-commerce.com 
...
define('TEXT_WELCOME_INDEX','VamShop - это интернет-магазин с открытым исходным кодом, разрабатываемый международным сообществом. Разрабатывается по модели открытых исходных кодов, установив VamShop, Вы получаете готовый к работе интернет-магазин.<br /><br />
      VamShop является открытой системой, работающей под управлением веб сервера Apache, в качестве базы данных используется MySQL, в качестве языка программирования используется PHP.<br /><br />
      VamShop может быть установлен на любой сервер, поддерживающий PHP и MySQL, в качестве операционной системы могут использоваться GNU/Linux, Solaris, BSD, либо Microsoft Windows.');
...
define('TEXT_WELCOME_STEP2','<b>Установка базы данных</b><br /><br />VamShop автоматически установит базу данных магазина.');
define('TEXT_WELCOME_STEP3','<b>Импорт базы данных.</b><br /><br />');
define('TEXT_WELCOME_STEP4','<b>Настройка конфигурационных файлов VamShop</b><br /><br /><b>Если есть старые конфигурационные файлы от предыдущих установок, VamShop удалит их автоматически.</b><br /><br />Инсталлятор сконфигурирует основные параметры БД и структуру файлов.');
...
define('TEXT_WELCOME_STEP7','<b>Настройка групп покупателей</b><br /><br />VamShop предоставляет широкие возможности управления ценами и скидками.<br /><br />
...
');
define('TEXT_WELCOME_FINISHED','<b>Установка VamShop успешно завершена!</b>');

// step1.php

define('TITLE_CUSTOM_SETTINGS','Настройки');
define('TEXT_IMPORT_DB','Импорт базы данных');
define('TEXT_IMPORT_DB_LONG','Импорт структуры базы данных VamShop.');
...
define('TEXT_DATABASE_LONG','Название базы данных, которая будет использоваться для установки интернет-магазина.<br />Если Вы не знаете название базы данных, свяжитесь со своим хостинг-провайдером.<br /><span class="errorText">База данных должна быть создана до начала установки магазина.</span>');
...
define('TEXT_WS_vam_LONG','Путь до директории, где находится интернет-магазин, обычно <i>/</i> или <i>/home/myname/public_html/vamshop/</i><br /> В большинстве случаев, Вам не нужно прописывать путь до директории, скрипт установки автоматически определит местонахождение магазина и пропишет путь до директории автоматически.');
...
define('TEXT_WS_CONFIGURATION_SUCCESS','<strong>VamShop</strong> - Настройка конфигурационных файлов успешно завершена!');
...
define('TITLE_ZONE_CONFIG_NOTE','* Замечание: VamShop может автоматически загрузить зоны Евросоюза в магазин.');
...
define('TEXT_SHOP_CONFIG_SUCCESS','Настройка магазина <strong>VamShop</strong> успешно завершена.');
define('TEXT_TEAM','');
...
define('TITLE_INDEX','Установка VamShop - Добро пожаловать');
define('TITLE_STEP1','Установка VamShop - ШАГ 1 / Настройки');
define('TITLE_STEP2','Установка VamShop - ШАГ 2 / Подключение к базе данных');
define('TITLE_STEP3','Установка VamShop - ШАГ 3 / Импорт базы данных');
define('TITLE_STEP4','Установка VamShop - ШАГ 4 / Настройка веб сервера');
define('TITLE_STEP5','Установка VamShop - ШАГ 5 / Запись конфигурационных файлов');
define('TITLE_STEP6','Установка VamShop - ШАГ 6 / Создание админа');
define('TITLE_STEP7','Установка VamShop - ШАГ 7 / Настройка цен');
define('TITLE_FINISHED','Установка VamShop - Установка завершена');
...
define('PHP_VERSION_ERROR','<b>Внимание!, Версия PHP слишком старая, для корректной работы VamShop необходим PHP 4.1.3 и выше.</b><br /><br />
                 Ваша версия PHP: <b><?php echo phpversion(); ?></b><br /><br />
                 VamShop не будет корректно работать на данном сервере, обновите PHP, либо смените сервер.');
...
define('TEXT_GD_LIB_GIF_SUPPORT_ERROR','<b><font color="ff0000">ОШИБКА</font></b><br />Установленная библиотека GDlib не поддерживает картинки в формате GIF, Вы не сможете использовать картинки GIF в магазине VamShop!');
