...
if (strstr($_SERVER['PHP_SELF'], FILENAME_CHECKOUT_PAYMENT) or strstr($_SERVER['PHP_SELF'], FILENAME_CHECKOUT_CONFIRMATION) or strstr($_SERVER['PHP_SELF'], FILENAME_CHECKOUT_SHIPPING))
