...
$box->assign('tpl_path','templates/'.CURRENT_TEMPLATE.'/');
  ...
  $admin_image = '<a href="' . vam_href_link_admin(FILENAME_START,'', 'SSL').'">'.vam_image_button('button_admin.gif', IMAGE_BUTTON_ADMIN).'</a>';
   ...
   if (isset($_GET['articles_id'])) {
    $admin_link_article='<a href="' . vam_href_link_admin('admin/'.FILENAME_ARTICLES, 'aID=' . $_GET['articles_id']) . '&amp;action=new_article' . '" onclick="window.open(this.href); return false;">' . vam_image_button('edit_article.gif', IMAGE_BUTTON_ARTICLE_EDIT) . '</a>';
  }
