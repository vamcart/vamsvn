...
/* -----------------------------------------------------------------------------------------
   ...
   (c) 2004	 xt:Commerce (search.php,v 1.9 2003/08/17); xt-commerce.com 
...
$box_smarty->assign('INPUT_SEARCH', xtc_draw_input_field('keywords', '', 'onkeyup="ajaxQuickFindUp(this);" id="quick_find_keyword"'));
