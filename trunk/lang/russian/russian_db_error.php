<?php
/* -----------------------------------------------------------------------------------------
   $Id: russian_db_error.php 1260 2008/02/07 13:24:46 VaM $
...
define('DB_ERR_MSG', "<br /><br /><center><font face=\"verdana,tahoma,arial\" size=\"2\" color=\"ff0000\"><b>"
                     ."Интернет-магазин закрыт на техническое обслуживание, заходите позже!</b></font><br /><br /><a href=\"http://vamshop.ru/support/modules/smartfaq/faq.php?faqid=32\" target=\"_blank\"><u>Проблема с MySQL. Как узнать причину ошибки. </u></a></center>"); // Сообщение, которое будет выводиться при возникновении проблем с MySQL сервером.
