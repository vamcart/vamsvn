...
define('DB_ERR_MAIL', 'Администратор <vam@test.com>'); // Укажите e-mail адрес и имя получателя, куда будут тприходить пиьсма с технической информацией, в случае возникновения проблем с MySQL сервером.
